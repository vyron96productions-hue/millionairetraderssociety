          ...
          <div className="two-col-grid" style={{ alignItems: 'center' }}>
            <div>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 32 }}>
                <TrackedAnchor href="https://millionairetraderssociety.com" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ fontSize: 16, padding: '15px 32px', background: '#289E54', boxShadow: '0 4px 20px rgba(40,158,84,0.4)' }} tracking={{ event: 'cta_click', button_text: 'Join the Workshop →', destination: 'https://millionairetraderssociety.com', page_section: 'hero' }}>
                  Join the Workshop →
                </TrackedAnchor>
