...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/vip-course`,    lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/workshop`,      lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/bundle`,        lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
